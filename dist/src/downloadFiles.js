                    ...
                    _loop_1 = function (file) {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    url = file.url;
                                    filePath = "".concat(dir, "/").concat(file.title);
                                    writer = fs_1.default.createWriteStream(filePath);
                                    return [4 /*yield*/, (0, axios_1.default)({ url: url, method: 'GET', responseType: 'stream' }).then(function (response) {
                                            return __awaiter(this, void 0, void 0, function () {
                                                var t;
                                                return __generator(this, function (_a) {
                                                    response.data.pipe(writer);
                                                    writer.on('finish', function () { return ((0, parseExcel_1.manifestParser)({ fileName: filePath })); });
                                                    return [2 /*return*/];
                                                });
                                            });
                                        })];
